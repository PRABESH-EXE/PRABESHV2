...
def psw():
	os.system('clear')
	banner()
	print(" [\u001b[36m>\033[1;30m] ENTER PASSWORD TO OUR ACCOUNT " )
	linex()
	upsw = input(" [\u001b[36m•\033[1;31m] PASSWORD HAL MUGI: " )
...
def login():
	try:
		...
		try:
			...
			animation(f'\033[0m \u001b[36m>>\033[1;30m CHECK YOUR INTERNET CONNECTION')
			exit()
	except IOError:
		login123()
...
def login_lagi334():
	try:
		clear()
		banner()
		print(""" [\u001b[36m1\033[1;37m] PLAY STOTE: DOWNLOAD KIWI BROWSER 
 [\u001b[36m2\033[1;37m] OPEN YOUTUBE 
 [\u001b[36m3\033[1;37m] GO TO SEARCH BAR : THEN SEARCH ' GET COOKIE FROM KIWI BROWSER '
 [\u001b[36m4\033[1;37m] THEN COPY COOKIE AND PASTE HERE""")
		linex()
		your_cookies = input(' [\u001b[36m•\033[1;37m] COOKIE HAL MUGI: ')
